...
describe("BalanceSlider - Thumb Interaction", () => {
  ...
  it("should render only requirement thumbs as interactive sliders", () => {
    ...
    expect(inputLabels.some((label) => label?.includes("cast windlance"))).toBe(
      true,
    );
    expect(inputLabels.some((label) => label?.includes("drink health"))).toBe(
      true,
    );
    expect(inputLabels.every((label) => !label?.includes("smoke pipe"))).toBe(
      true,
    );
  });
  ...
  it("should render consumption indicators as non-interactive elements", () => {
    ...
    const consumptionIndicators =
      container.querySelectorAll(".consumption-thumb");
  ...
  it("should render consumption periods as background indicators", () => {
    ...
    const consumptionPeriods = container.querySelectorAll(
      ".consumption-period",
    );
